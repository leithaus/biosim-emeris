...
public class RemoveNodesRequest extends RequestBody {
	...
	public RemoveNodesRequest(Node n) {
	...
	public static class RemoveNodesRequestContainerContext extends m3.gwt.props.impl.AbstractContainerContext {
	    public m3.gwt.props.PropertyContext uidList = new m3.gwt.props.impl.AbstractPropertyContext<RemoveNodesRequest,java.util.List<biosim.client.model.Uid>>(this, "uidList", java.util.List.class, 0, biosim.client.model.Uid.class, false) {
	    	    protected java.util.List<biosim.client.model.Uid> getImpl(RemoveNodesRequest bean) { return bean.getUidList(); }
	    	    protected void setImpl(RemoveNodesRequest bean, java.util.List<biosim.client.model.Uid> value ) { bean.setUidList(value);}
	    };
