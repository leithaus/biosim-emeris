...
with ResizeHandler with HasSelectionHandlers[TreeItem] 
with AgentApplication {
  ...
  // Add AgentApplication
  installAgentPanel( layout, userEngagementPanel )
