 ...
 * the License.
 */
package com.biosimilarity.gwt.agent.generator
...
import com.biosimilarity.gwt.agent.client.ShowcaseConstants
import com.biosimilarity.gwt.agent.client.ShowcaseAnnotations.ShowcaseData
import com.biosimilarity.gwt.agent.client.ShowcaseAnnotations.ShowcaseRaw
...
class ShowcaseGenerator extends Generator {
  ...
  private val SRC_CSS = List(
      ...
      "com/biosimilarity/gwt/agent/public/$THEME/Showcase.css")
