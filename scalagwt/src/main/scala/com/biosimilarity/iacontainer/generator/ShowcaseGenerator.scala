 ...
 * the License.
 */
package com.biosimilarity.iacontainer.generator
...
import com.biosimilarity.iacontainer.client.ShowcaseConstants
import com.biosimilarity.iacontainer.client.ShowcaseAnnotations.ShowcaseData
import com.biosimilarity.iacontainer.client.ShowcaseAnnotations.ShowcaseRaw
...
class ShowcaseGenerator extends Generator {
  ...
  private val SRC_CSS = List(
      ...
      "com/biosimilarity/iacontainer/public/$THEME/Showcase.css")
